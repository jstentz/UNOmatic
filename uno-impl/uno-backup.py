...
'''
Notes:
 * Can't really do inheritance, since there are parts of the player that should play...
 * Maybe there should be a BaseUNO, a BasePlayer, and then have SoftwareUNO, and PhysicalUNO, etc

 
 * I think it makes sense to have a hardware player and software player
...
'''
Input an action: _______


UNO State:
 * Literally only stores information
 * Does nothing else
 * Can pass in the state to a card and it will update the state
  * but what about dealing cards? it technically needs to not deal the cards yet
