...
image_path = './bot_data/images/'

infile_path = './bot_data/bot_data_labels.csv'
outfile_path = './bot_data/bot_data_labels2.csv'
...
for line in infile.readlines():
  ...
  new_path = os.path.join(image_path, path.removeprefix('bot_data/'))
